...
class Kubernetes_Ui_VoltaGpu_01(EnvironmentSetup):
    ...
    def pgan_manual1(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_01_voltaGpu_pgan_manual1_setupscreen1.png")
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_01_voltaGpu_pgan_manual1_elapsedtime1.png")
        sleep(2)
    ...
    def pgan_manual2(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_01_voltaGpu_pgan_manual2_etupScreen2.png")
        ...
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_01_voltaGpu_pgan_manual2_elapsedtime2.png")
        sleep(2)
        assert isinstance(myElem.text, object)
        print("Pgan Manual -", str(myElem.text))
    ...
    def test_pagan_manual_manual(self):
