...
class Kubernetes_Ui_VoltaGpu_06(EnvironmentSetup):
    ...
    def pgan_auto1(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_06_voltaGpu_pgan_auto1_setupscreen1.png")
        # -----Setup screen ------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_06_voltaGpu_pgan_auto1_elapsedtime1.png")
        sleep(2)
    ...
    def pgan_manual2(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_06_voltaGpu_pgan_manual2_setupscreen2.png")
        ...
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_06_voltaGpu_pgan_manual2_elapsedtime2.png")
        sleep(2)
        assert isinstance(myElem.text, object)
    ...
    def pgan_manual3(self):
        ...
        # ScreenShot Relative Path
        ss_path = '/Parallel/MultiUser_MultiInstance6/'
        # Creating object of screenshot utility
        ss = SS(driver1)
        user = self.driver1.find_element_by_name("username")
        user.send_keys(Admin)
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_06_voltaGpu_pgan_manual3_setupscreen3.png")
        setupbtn = self.driver1.find_element(By.ID, 'setupbtn')
        setupbtn.click()
        sleep(28)
        ...
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_06_voltaGpu_pgan_manual3_elapsedtime3.png")
        sleep(2)
        assert isinstance(myElem.text, object)
        print("Pgan Manual -", str(myElem.text))
    ...
    def test_pagan_auto_manual2(self):
        u1 = multiprocessing.Process(target=self.pgan_auto1)
