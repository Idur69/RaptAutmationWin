...
class Kubernetes_Ui_VoltaGpu_07(EnvironmentSetup):
    ...
    def pgan_manual1(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_07_voltaGpu_pgan_manual1_setupscreen1.png")
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_07_voltaGpu_pgan_manual1_elapsedtime1.png")
        sleep(2)
    ...
    def pgan_auto2(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_07_voltaGpu_pgan_auto2_setupscreen2.png")
        # -----Setup screen ------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_07_voltaGpu_pgan_auto2_elapsedtime2.png")
        sleep(2)
        assert isinstance(myElem.text, object)
        print("Pgan Auto -", str(myElem.text))

        # gettime = self.driver2.find_elements_by_id("elapsedTime")
    ...
    def pgan_manual3(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_07_voltaGpu_pgan_manual3_setupscreen3.png")
        setupbtn = self.driver1.find_element(By.ID, 'setupbtn')
        setupbtn.click()
        sleep(28)
        ...
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_07_voltaGpu_pgan_manual3_elapsedtime3.png")
        sleep(2)
        assert isinstance(myElem.text, object)
        print("Pgan Manual -", str(myElem.text))
    ...
    def test_pagan_auto_manual2(self):
        u1 = multiprocessing.Process(target=self.pgan_manual1)
        u2 = multiprocessing.Process(target=self.pgan_auto2)
