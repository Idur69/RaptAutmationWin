...
class Kubernetes_Ui_VoltaGpu_03(EnvironmentSetup):
    ...
    def pgan_manual(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_03_voltaGpu_pgan_manual1_setupscreen1.png")
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_03_voltaGpu_pgan_manual1_elapsedtime1.png")
        sleep(2)
    ...
    def pgan_auto(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_03_voltaGpu_pgan_auto2_setupscreen2.png")
        # -----Setup screen ------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_03_voltaGpu_pgan_auto2_elapsedtime2.png")
        sleep(2)
        assert isinstance(myElem.text, object)
    ...
    def test_pagan_auto_manual(self):
        ...
        u2 = multiprocessing.Process(target=self.pgan_auto)
