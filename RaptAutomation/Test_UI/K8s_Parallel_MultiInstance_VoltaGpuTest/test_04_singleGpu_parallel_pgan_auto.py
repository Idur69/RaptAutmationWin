...
class Kubernetes_Ui_VoltaGpu_04(EnvironmentSetup):
    ...
    def pgan_auto1(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_04_voltaGpu_pgan_auto1_setupscreen1.png")
        # -----Setup screen ------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_04_voltaGpu_pgan_auto1_elapsedtime1.png")
        sleep(2)
    ...
    def pgan_auto2(self):
        ...
        print("Your selected Auto")
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_04_voltaGpu_pgan_auto2_setupscreen2.png")
        # -----Setup screen ------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_04_voltaGpu_pgan_auto2_elapsedtime2.png")
        sleep(2)
        assert isinstance(myElem.text, object)
        print("Pgan Auto -", str(myElem.text))
