...
class Kubernetes_Ui_VoltaGpu_02(EnvironmentSetup):
    ...
    def pgan_auto(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_02_voltaGpu_pgan_auto1_setupscreen1.png")
        # -----Setup screen ------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_02_voltaGpu_pgan_auto1_elapsedtime2.png")
        sleep(2)
    ...
    def pgan_manual(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_02_voltaGpu_pgan_manual2_setupscreen2.png")
        ...
        Train.click()
        #It is waiting becoze of not having space
        sleep(570)  #This is for single user time
        sleep(200)
        # ------- Gpu Usage --------------------
        ...
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_02_voltaGpu_pgan_manual2_elapsedtime2.png")
        sleep(2)
        assert isinstance(myElem.text, object)
    ...
    def test_pagan_auto_manual(self):
        ...
        u2 = multiprocessing.Process(target=self.pgan_manual)
