...
class Rvirtus_Ui_Nfs_Image_Manual(EnvironmentSetup):
    ...
    def test_nfs_image_manual(self):
        ...
        memory = percentages.memory_06
        core = percentages.core_06
        # ------- Login Details ------------
        user = LoginUsers()
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_12_nfs_image_clf_manual_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_12_nfs_image_clf_manual_elapsedtime.png")
        sleep(2)
