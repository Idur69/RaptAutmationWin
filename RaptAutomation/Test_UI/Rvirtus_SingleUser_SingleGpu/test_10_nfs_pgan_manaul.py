...
class Rvirtus_Ui_Nfs_Pgan_Manual(EnvironmentSetup):
    ...
    def test_nfs_pgan_manual(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_nfs_pgan_manual_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_nfs_pgan_manual_elapsedtime.png")
        sleep(3)
