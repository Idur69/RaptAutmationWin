...
class Rvirtus_Parallel_02(EnvironmentSetup):
    ...
    def mnist_auto_01(self):
        ...
        '''
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_02_parallel_mnist_auto1_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_02_parallel_mnist_auto2_elapsedtime.png")
        sleep(2)
    ...
    def mnist_manual_02(self):
        ...
        sleep(8)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_parallel_02_mnist_manual2_setupsscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_parallel_02_mnist_manual2_elapsedtime.png")
        sleep(2)
        assert isinstance(myElem.text, object)
