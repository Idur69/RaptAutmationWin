...
class Rvirtus_Parallel_03(EnvironmentSetup):
    ...
    def mnist_manual_01(self):
        ...
        sleep(4)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_parallel_03_mnist_manual1_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_parallel_03_mnist_manual1-elapsedtime.png")
        sleep(3)
    ...
    def mnist_manual_02(self):
        ...
        # ------Memory and core Percentages ----------
        percentages = Memory_and_Core_Percentages()
        gpuper = percentages.memory_04
        coreper = percentages.core_04
        # ------- Login Details ------------
        user = LoginUsers()
        ...
        sleep(8)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_parallel_03_mnist_manual2_setupscreen.png")
        # -------------------- setup btn -----------------
    ...
    def test_mnist_manual_mnist_manual(self):
