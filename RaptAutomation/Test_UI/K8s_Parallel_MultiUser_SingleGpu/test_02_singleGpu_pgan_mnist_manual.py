...
class Kubernetes_Ui_Parallel_Pgan_Mnist_02(EnvironmentSetup):
    ...
    def pgan_manual(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_02_singlGpu_pgan_manual_setupscreen1.png")
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_02_singlGpu_pgan_manual_elapsedtime1.png")
        sleep(10)
    ...
    def mnist_manual(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_02_singlGpu__mnist_manual_setupscreen2.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_02_singlGpu_mnist_manual_elapsedtime2.png")
        sleep(2)
        assert isinstance(myElem.text, object)
