...
class Kubernetes_Ui_MultiGpu_06(EnvironmentSetup):
    ...
    def test_local_image_manual(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_04_multigpus_8_image_manual_setupscreen.png")
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_04_multigpus_8_image_manual_elapsedtime.png")
        sleep(2)
