...
class Kubernetes_Ui_MultiGpu_04(EnvironmentSetup):
    ...
    def test_local_pgan_manual(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_01_multigpus_8_pgan_manual_setupscreen.png")
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_01_multigpus_8_pgan_manual_elapsedtime.png")
        sleep(2)
