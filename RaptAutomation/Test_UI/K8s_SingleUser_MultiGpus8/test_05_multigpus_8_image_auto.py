...
class Kubernetes_Ui_MultiGpu_05(EnvironmentSetup):
    ...
    def test_local_image_auto(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_03_multigpus_8_image_auto_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_03_multigpus_8_image_auto_elapsedtime.png")
        sleep(2)
