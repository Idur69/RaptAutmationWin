...
class Kubernetes_Ui_MultiGpu_03(EnvironmentSetup):
    ...
    def test_local_pgan_auto(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_02_multigpus_8_pgan_auto_setupscreen.png")
        #-----Setup screen ------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_02_multigpus_8_pgan_auto_elapsedtime.png")
        sleep(2)
