...
class Rvirtus_Ui_Multi_Gpus_01(EnvironmentSetup):
    ...
    def test_local_mnist_auto(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_01_local_mnist_auto-SetupsScreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_02_local_mnist_auto-ElapsedTime.png")
        sleep(2)
