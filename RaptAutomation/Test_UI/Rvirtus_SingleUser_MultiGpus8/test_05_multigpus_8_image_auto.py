...
class Rvirtus_Ui_Multi_Gpus_05(EnvironmentSetup):
    ...
    def test_local_image_auto(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_05_multigpu_image_clf_auto_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_05_multigpu_image_clf_elapsedtime.png")
        sleep(2)
