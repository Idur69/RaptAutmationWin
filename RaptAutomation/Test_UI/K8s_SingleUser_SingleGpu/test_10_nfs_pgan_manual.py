...
class Kubernetes_Ui_Nfs_Pgan_Manual(EnvironmentSetup):
    ...
    def test_nfs_pgan_manual(self):
        ...
        memory = percentages.memory_04
        core = percentages.core_04
        # ------- Login Details ------------
        user = LoginUsers()
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_10_nfs_pgan_manual_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_10_nfs_pgan_manual_elapsedtime.png")
        sleep(2)
        assert isinstance(myElem.text, object)
        print("Pgan Manaual -", str(myElem.text))
