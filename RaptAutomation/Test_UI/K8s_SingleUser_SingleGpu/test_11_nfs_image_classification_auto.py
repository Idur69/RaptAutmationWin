...
class Kubernetes_Ui_Nfs_Image_Auto(EnvironmentSetup):
    ...
    def test_nfs_image_auto(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_11_nfs_image_auto_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_11_nfs_image_auto_elapsedtime.png")
        sleep(2)
