...
class Kubernetes_Ui_Pgan_Auto(EnvironmentSetup):
    ...
    def test_local_pgan_auto(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_03_pgan_auto_setupscreen.png")
        #-----Setup screen ------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_03_pgan_auto_elapsedtime.png")
        sleep(2)
        assert isinstance(myElem.text, object)
        print("Pgan Auto -", str(myElem.text))
        #logs = self.driver1.get_log('browser')
        #print("Your logs : ", logs)
