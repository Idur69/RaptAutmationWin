...
class Kubernetes_Ui_Inferencing_03(EnvironmentSetup):

    def test_inferencing_image_classification_auto(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_21_inferencing_image_auto_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_21_inferencing_image_auto_elapsedtime.png")
        sleep(2)
        assert isinstance(myElem.text, object)
        print("image_classification Auto -", str(myElem.text))
