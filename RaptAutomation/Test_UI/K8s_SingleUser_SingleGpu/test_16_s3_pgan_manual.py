...
class Kubernetes_Ui_S3_Pgan_Manual(EnvironmentSetup):
    ...
    def test_s3_pgan_manual(self):
        ...
        memory = percentages.memory_16
        core = percentages.core_16
        # ------- Login Details ------------
        user = LoginUsers()
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_16_s3_pgan_manual_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_16_s3_pgan_manual_elapsedtime.png")
        sleep(2)
