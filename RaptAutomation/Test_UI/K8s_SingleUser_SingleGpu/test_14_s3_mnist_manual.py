...
class Kubernetes_Ui_S3_Mnist_Manual(EnvironmentSetup):
    ...
    def test_s3_mnist_manual(self):
        ...
        memory = percentages.memory_14
        core = percentages.core_14
        # ------- Login Details ------------
        user = LoginUsers()
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_14_s3_mnist_manual_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_14_s3_mnist_manual_elapsedtime.png")
        sleep(2)
