...
class Kubernetes_Ui_S3_Image_Manual(EnvironmentSetup):
    ...
    def test_s3_image_manual(self):
        ...
        memory = percentages.memory_18
        core = percentages.core_18
        # ------- Login Details ------------
        user = LoginUsers()
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_18_s3_image_manual_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        textpath.clear()
        flowerpath = "python -u /tensorflow/training/flower_classification/retrain-new.py --model_dir=/tensorflow/inception --image_dir /tensorflow/datasets/flower_photos --bottleneck_dir=/tensorflow/datasets/bottlenecks-new --how_many_training_steps 50"
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_18_s3_image_manual_elapsedtime.png")
        sleep(2)
