...
class Kubernetes_Ui_S3_Pgan_Auto(EnvironmentSetup):
    ...
    def test_s3_pgan_auto(self):
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_15_s3_pgan_auto_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # --------Screen shot-2 -----------
        ss.ScreenShot(ss_path + "test_15_s3_pgan_auto_elapsedtime.png")
        sleep(2)
