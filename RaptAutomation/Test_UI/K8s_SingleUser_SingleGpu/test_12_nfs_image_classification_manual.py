...
class Kubernetes_Ui_Nfs_Image_Manual(EnvironmentSetup):
    ...
    def test_nfs_image_manual(self):
        ...
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_12_nfs_image_manual_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_12_nfs_image_manual_elapsedtime.png")
        sleep(2)
