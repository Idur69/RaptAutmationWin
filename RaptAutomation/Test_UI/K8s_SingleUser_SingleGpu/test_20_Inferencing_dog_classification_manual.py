...
class Kubernetes_Ui_Inferencing_02(EnvironmentSetup):

    def test_inferencing_dog_classification_manual(self):
        ...
        gpuper = percentages.memory_20
        coreper = percentages.core_20
        # ------- Login Details ------------
        user = LoginUsers()
        ...
        sleep(2)
        # ------Screenshot-1-----------
        ss.ScreenShot(ss_path + "test_20_inferencing_dog_image_manual_setupscreen.png")
        # -------------------- setup btn -----------------
        ...
        sleep(1)
        # ------Screenshot-2-----------
        ss.ScreenShot(ss_path + "test_20_inferencing_dog_image_manual_elapsedtime.png")
        sleep(2)
        assert isinstance(myElem.text, object)
        print("dog_classification Manual -", str(myElem.text))
