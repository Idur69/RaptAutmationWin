...
class Kubernetes_Multiusers_06(unittest.TestCase):
    ...
    def test_parallel_nfspganauto_s3mnistauto(self):
        ...
        nfs_cmd = "/home/ubuntu/test/raptcli raptrun" + " -name " + name + " -f " + fw + " -a " + application + " -d " + dirpath + " -cf " + config + " -t " + training + " -type " + type1 + " -l " + location + " -mode " + mode + " -nfsip " + nfsip + " -nfspath " + nfspath

        s3_cmd = "/home/ubuntu/test/raptcli raptrun" + " -name " + name2 + " -f " + fw2 + " -a " + application2 + " -d " + dirpath2 + " -t " + training2 + " -type " + type2 + " -l " + location2 + " -mode " + mode2 + " -k " + bkeys2 + " -bucket " + bname2
