...
class Kubernetes_Multiusers_09(unittest.TestCase):
    ...
    def test_parallel_s3pganauto_nfsmnistauto(self):
        ...
        s3_cmd = "/home/ubuntu/test/raptcli raptrun" + " -name " + name + " -f " + fw + " -a " + application + " -d " + dirpath + " -cf " + config + " -t " + training + " -type " + type1 + " -l " + location + " -mode " + mode + " -k " + bkeys + " -bucket " + bname
