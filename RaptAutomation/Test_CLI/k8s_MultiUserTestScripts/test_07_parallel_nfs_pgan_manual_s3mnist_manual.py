...
class Kubernetes_Multiusers_07(unittest.TestCase):
    ...
    def test_parallel_nfspganmanual_s3mnistmanual(self):
        ...
        nfs_cmd = "/home/ubuntu/test/raptcli raptrun" + " -name " + name + " -f " + fw + " -a " + application + " -d " + dirpath + " -cf " + config + " -t " + training + " -type " + type1 + " -l " + location + " -mode " + mode + " -p " + memoryper + " -cp " + coreper + " -nfsip " + nfsip + " -nfspath " + nfspath
