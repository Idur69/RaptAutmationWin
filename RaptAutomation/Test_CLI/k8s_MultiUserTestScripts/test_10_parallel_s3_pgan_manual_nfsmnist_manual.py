...
class Kubernetes_Multiusers_10(unittest.TestCase):
    ...
    def test_parallel_s3pganmanual_nfsmnistmanual01(self):
        ...
        s3_cmd = "/home/ubuntu/test/raptcli raptrun"+" -name "+ name +" -f " + fw +" -a " +application +" -d " + dirpath +" -cf " + config +" -t " + training +" -type " + type1 +" -l " + location +" -mode " + mode +" -p " + memoryper +" -cp " + coreper +" -k " + bkeys +" -bucket " + bname
