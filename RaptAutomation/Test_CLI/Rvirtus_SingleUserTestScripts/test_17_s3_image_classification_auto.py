...
class Rvirtus_Cli_S3_Image_Auto(unittest.TestCase):
    ...
    def test_s3_image_auto(self):
       ...
       # config = path.s3_pgan_config
        ...
        s3image_cmd = "raptrun"+" -name " + name+ " -f " + fw +" -a " + application +" -d " + dirpath +" -t " + training +" -type " + type1+" -l " + location +" -mode " + mode +" -k " + bkeys +" -bucket " + bname +" -m " + modeldir+" -i " + imagedir +" -b " + bottleneck +" -s " + steps + " -pf " + platform
