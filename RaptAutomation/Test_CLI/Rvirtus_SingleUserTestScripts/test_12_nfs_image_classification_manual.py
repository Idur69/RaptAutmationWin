...
class Rvirtus_Cli_Nfs_Image_Manual(unittest.TestCase):
    ...
    def test_nfs_image_manual(self):
        ...
        nfsimage_cmd = "raptrun"+" -name " + name+ " -f " + fw +" -a " + application +" -t " + training +" -type " + type1+" -l " + location +" -mode " + mode +" -p " + memoryper +"-cp " + coreper +" -m " + modeldir+" -i " + imagedir +" -b " + bottleneck +" -s " + steps +" -nfsip " +nfsip + " -nfspath " + nfspath + " -pf " + platform
