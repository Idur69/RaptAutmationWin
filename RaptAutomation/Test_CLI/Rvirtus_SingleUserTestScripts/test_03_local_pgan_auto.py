...
class Rvirtus_Cli_Pgan_Auto(unittest.TestCase):
    ...
    def test_local_pgan_auto(self):
        ...
        pgan_cmd = "raptrun"+" -name " + name +" -f " + fw +" -a " + application +" -d " + dirpath +" -cf " +config +" -t " + training +" -type " + type1+" -l " +location+" -mode " + mode + " -pf " + platform
        #cmd = "raptrun -name demotwo -f tensorflow -a pggan -d /home/ubuntu/tensorflow-UI/ -cf /tensorflow/training/pgan/config.py -t /tensorflow/training/pgan/train.py -type rapt -l local -mode manual -p 40 -cp 90 -pf raptvirtus"
       # cmd = raptrun + " -name " + name + " -f " + fw + " -a " + application + " -d " + dirpath + " -t " + training + " -type " + type1 + " -l " + location + " -mode " + mode

        #cmd = "raptrun -name demotwovi -f tensorflow -a pggan -d /home/ubuntu/tensorflow-UI/ -cf /tensorflow/training/pgan/config.py -t /tensorflow/training/pgan/train.py -type rapt -l local -mode auto -pf raptvirtus"
