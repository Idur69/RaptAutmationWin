...
class Kubernetes_Cli_Pgan_Manual(unittest.TestCase):
    ...
    def test_local_pgan_manual(self):
       ...
       # raptrun = cmddata.raptrun
        ...
        pgan_cmd = "raptrun train"+" -name " + name +" -f " + fw +" -a " + application +" -d " + dirpath +" -cf " +config +" -t " + training +" -type " + type1+" -l " +location+" -mode " + mode+" -p " + memoryper+" -cp " + coreper
