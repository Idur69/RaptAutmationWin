...
class Kubernetes_Cli_Image_Manual(unittest.TestCase):
    ...
    def test_local_image__manual(self):
        ...
        image_cmd = "raptrun train"+" -name " + name+ " -f " + fw +" -a " + application +" -d " + dirpath +" -t " + training +" -type " + type1+" -l " + location +" -mode " + mode +" -p " + memoryper +" -cp " + coreper  +" -m " + modeldir+" -i " + imagedir +" -b " + bottleneck +" -s " + steps
