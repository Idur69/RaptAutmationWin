...
class Kubernetes_Cli_Nfs_Pgan_Auto(unittest.TestCase):
    ...
    def test_nfs_pgan_auto(self):
        ...
        #cmd = "raptrun -name demotwo -f tensorflow -a pggan -d /home/ubuntu/tensorflow-UI/ -cf /tensorflow/training/pgan/config.py -t /tensorflow/training/pgan/train.py -type rapt -l nfs -mode manual -p 80 -cp 90 -nfsip 54.149.247.58 -nfspath /home/ubuntu/tensorflow-UI"
        nfspgan_cmd = "raptrun train"+" -name " + name +" -f " + fw +" -a " + application +" -d " + dirpath +" -cf "+ config +" -t " + training +" -type " + type1 +" -l " + location +" -mode " + mode +" -nfsip " +nfsip + " -nfspath " + nfspath
