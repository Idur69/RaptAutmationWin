...
class Kubernetes_Cli_Nfs_Image_Auto(unittest.TestCase):
    ...
    def test_nfs_image_auto(self):
        ...
        nfsimage_cmd = "raptrun train"+" -name " + name+ " -f " + fw +" -a " + application +" -t " + training +" -type " + type1+" -l " + location +" -mode " + mode +" -m " + modeldir+" -i " + imagedir +" -b " + bottleneck +" -s " + steps +" -nfsip " +nfsip + " -nfspath " + nfspath
