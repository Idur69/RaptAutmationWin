...
class Kubernetes_Cli_S3_Pgan_Manual(unittest.TestCase):
    ...
    def test_s3_pgan_manual(self):
        ...
        s3pgan_cmd = "raptrun train"+" -name "+ name +" -f " + fw +" -a " +application +" -d " + dirpath +" -cf " + config +" -t " + training +" -type " + type1 +" -l " + location +" -mode " + mode +" -p " + memoryper +"-cp " + coreper +" -k " + bkeys +" -bucket " + bname
