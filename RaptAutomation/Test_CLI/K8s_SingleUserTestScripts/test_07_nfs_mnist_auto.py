...
class Kubernetes_Cli_Nfs_Mnist_Auto(unittest.TestCase):
    ...
    def test_nfs_mnist_auto(self):
       ...
       # raptrun = cmddata.raptrun
        ...
        #cmd = "raptrun -name demotwo -f tensorflow -a mnist -d /home/ubuntu/tensorflow-UI/ -t /tensorflow/training/Mnist_classification/mnist_gpu.py -type rapt -l nfs -mode manual -p 50 -cp 90 -nfsip 54.149.247.58 -nfspath /home/ubuntu/tensorflow-UI"
        nfsmnist_cmd = "raptrun train"+" -name " + name +" -f " + fw +" -a " + application +" -d " + dirpath +" -t " + training +" -type " + type1 +" -l " + location +" -mode " + mode +" -nfsip " +nfsip + " -nfspath " + nfspath
