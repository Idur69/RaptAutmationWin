...
class Kubernetes_Cli_S3_Mnist_Auto(unittest.TestCase):
    ...
    def test_s3_mnist_auto(self):
       ...
       # raptrun = cmddata.raptrun
        ...
        s3mnist_cmd = "raptrun train"+" -name "+ name +" -f " + fw +" -a " +application +" -d " + dirpath +" -t " + training +" -type " + type1 +" -l " + location +" -mode " + mode +" -k " + bkeys +" -bucket " + bname
