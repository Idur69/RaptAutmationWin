...
class Rvirtus_Multiusers_08(unittest.TestCase):
    ...
    def run_nvidia_smi(self, nvidiasmi):
        ...
        print(nvidia)
    def test_parallel_s3mnistmanual_nfsmnistmanual(self):
        ...
        print("**********this is your command-1 *************" + str(s3_cmd))
        print("**********this is your command-2 *************" + str(nfs_cmd))
