...
class Rvirtus_Multiusers_03(unittest.TestCase):
    ...
    def run_nvidia_smi(self, nvidiasmi):
        ...
        print(nvidia)
    def test_parallel_pganmanual_mnistauto01(self):
        ...
        training2 = path2.mnist_deep
        type2 = path2.type1
        location2 = path2.location
        mode2 = path2.mode_auto
        platform2 = path2.platform

        pgan_cmd = "/home/ubuntu/test/raptcli raptrun" + " -name " + name + " -f " + fw + " -a " + application + " -d " + dirpath + " -cf " + config + " -t " + training + " -type " + type1 + " -l " + location + " -mode " + mode + " -p " + memoryper + " -cp " + coreper + " -pf " + platform

        mnist_cmd = "/home/ubuntu/test/raptcli raptrun" + " -name " + name2 + " -f " + fw2 + " -a " + application2 + " -d " + dirpath2 + " -t " + training2 + " -type " + type2 + " -l " + location2 + " -mode " + mode2 + " -pf " + platform2
        ...
        #mnist_cmd = "raptrun -name demothree -f tensorflow -a mnist -d /home/ubuntu/tensorflow-UI/ -t /tensorflow/training/Mnist_classification/mnist_gpu.py -type rapt -l local -mode auto"
