...
class Rvirtus_Multiusers_05(unittest.TestCase):
    ...
    def test_parallel_nfsmnistmanual_s3mnistmanual(self):
        ...
        nfs_cmd = "/home/ubuntu/test/raptcli raptrun"+" -name " + name +" -f " + fw +" -a " + application +" -d " + dirpath + training +" -type " + type1 +" -l " + location +" -mode " + mode +" -p " + memoryper +" -cp " + coreper +" -nfsip " +nfsip + " -nfspath " + nfspath + " -pf " + platform
