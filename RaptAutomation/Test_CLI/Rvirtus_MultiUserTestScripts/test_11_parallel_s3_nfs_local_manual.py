...
class Rvirtus_Multiusers_11(unittest.TestCase):
    ...
    def test_parallel_mnistmanual_s3_nfs_local(self):
        ...
        training2 = path2.nfs_mnist_deep
        type2 = path2.type1
        ...
        training3 = path3.mnist_deep
        type3 = path3.type1
        location3 = path3.location
        mode3 = path3.mode_manual
        memoryper3 = user1.memoryper
        coreper3 = user1.coreper
        platform3 = path3.platform

        s3_cmd = "/home/ubuntu/test/raptcli raptrun" + " -name " + name + " -f " + fw + " -a " + application + " -d " + dirpath + " -t " + training + " -type " + type1 + " -l " + location + " -mode " + mode + " -p " + memoryper + " -cp " + coreper + " -k " + bkeys + " -bucket " + bname + " -pf " + platform
        ...
        local_cmd = "/home/ubuntu/test/raptcli raptrun" + " -name " + name3 + " -f " + fw3 + " -a " + application3 + " -d " + dirpath3 + " -t " + training3 + " -type " + type3 + " -l " + location3 + " -mode " + mode3 + " -p " + memoryper3 + " -cp " + coreper3 + " -pf " + platform3
