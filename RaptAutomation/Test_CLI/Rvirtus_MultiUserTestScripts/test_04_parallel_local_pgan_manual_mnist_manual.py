...
class Rvirtus_Multiusers_04(unittest.TestCase):
    ...
    def test_parallel_pganmanual_mnistmanual01(self):
        ...
        mnist_cmd = "/home/ubuntu/test/raptcli raptrun" + " -name " + name2 + " -f " + fw2 + " -a " + application2 + " -d " + dirpath2 + " -t " + training2 + " -type " + type2 + " -l " + location2 + " -mode " + mode2 + " -p " + memoryper2 + " -cp " + coreper2 + " -pf " + platform2
