...
class Rvirtus_Multiusers_01(unittest.TestCase):
    ...
    def test_parallel_auto_manual_01(self):
        ...
        cmd1 = "/home/ubuntu/test/raptcli raptrun" + " -name " + name + " -f " + fw + " -a " + application + " -d " + dirpath + " -t " + training + " -type " + type1 + " -l " + location + " -mode " + mode + " -pf " + platform
