...
class Kubernetes_Cli_Multiusers_03(unittest.TestCase):
    ...
    def run_nvidia_smi(self, nvidiasmi):
        ...
        print(nvidia)
    def test_parallel_auto_manual_multigpus8(self):
        ...
        cmd1 = "/home/ubuntu/test/raptcli raptrun" + " -name " + name + " -f " + fw + " -a " + application + " -d " + dirpath + " -t " + training + " -type " + type1 + " -l " + location + " -mode " + mode
