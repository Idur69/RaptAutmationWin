...
class Kubernetes_Cli_Multiusers_04(unittest.TestCase):
    ...
    def run_nvidia_smi(self, nvidiasmi):
        ...
        print(nvidia)
    def test_parallel_mnist_multigpus8(self):
        ...
        memoryper = user1.memoryper_multigpus
        coreper = user1.coreper_multigpus
        # second user details -----------------
        user2 = userTwo 
        ...
        memoryper2 = user2.memoryper_multigpus
        coreper2 = user2.coreper_multigpus
