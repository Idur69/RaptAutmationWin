...
class Kubernetes_Cli_MultiGpu_Mnist_Auto8(unittest.TestCase):
    ...
    def test_local_mnist_auto_multigpus8(self):
       ...
       # memoryper = cmddata.memoryper
        ...
        mnist_cmd = "/home/ubuntu/test/raptcli raptrun"+" -name " + name +" -f " + fw +" -a " + application +" -d " + dirpath +" -t " + training +" -type " + type1 +" -l " + location +" -mode " + mode 
